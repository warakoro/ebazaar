...
public enum ViewOrdersUIControl {
	 ...
	 * 
	 * @Override public void handle(ActionEvent evt) { ordersWindow = new
	 * OrdersWindow(primaryStage);
	 * ordersWindow.setData(FXCollections.observableList
	 * (ViewOrdersData.INSTANCE.getOrders())); ordersWindow.show();
	 * primaryStage.hide(); } }
	 */
